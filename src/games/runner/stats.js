...
// 기록 키는 **테마가 갖는다.** 여기 문자열로 박혀 있으면 두 번째 러너 게임의 운동
// 데이터가 웜업 기록에 그대로 합쳐진다 — 나중에 "정글에서 아이가 얼마나 뛰었나"를
// 물어볼 수 없게 되고, 한 번 섞인 것은 되돌리기 어렵다.
//
// 우주 테마의 값은 'warmup-obstacle'로 **그대로 둔다.** 예전 'japari-run'에서
// 이미 한 번 옮겼고, 여기서 또 바꾸면 쌓인 기록이 다시 갈린다.
const GAME_ID = () => theme().id;
